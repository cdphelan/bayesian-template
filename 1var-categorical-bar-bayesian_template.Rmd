...
static_prior_plot_1(prior_draws)
```
...
# this function is defined in 'plotting_functions.R', if you wish to customize the aesthetics.
prior_HOPs = animate(HOPs_plot_1(more_prior_draws), nframes = n_draws * 2, fps = frames_per_second)
prior_HOPs
```
...
# Animate the posterior draws with HOPs
# this function is defined in 'plotting_functions.R', if you wish to customize the aesthetics.
post_HOPs = animate(HOPs_plot_1(p), nframes = n_draws * 2, fps = frames_per_second) 
post_HOPs
