---
title: "Bayesian template for two categorical independent variables (line graph)"
...
This template is for data with **two categorical independent variables** and will produce a **line chart**. If your analysis includes a **two-way ANOVA**, this might be the right template for you. In most cases, we *do not recommend* using line charts for this type of analysis; a bar chart is usually the better option. 
...
mydata$x1 = mydata$order #CHANGE ME 2
mydata$x2 = mydata$attitude #CHANGE ME 3
mydata$y = mydata$persuasiveness #CHANGE ME 4

# label the axes on the plots
x_lab = "Before/after support" #CHANGE ME 5
y_lab = "Persuasiveness" #CHANGE ME 6
