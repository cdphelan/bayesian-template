...
<span style="color:#3875d8;font-size:2em">**One continuous & one categorical independent variable (line graph)**</span></center>
...
If you are using Windows, first you will need to manually install RStan and Rtools. Follow the instructions [here](https://github.com/stan-dev/rstan/wiki/Installing-RStan-on-Windows) to install both. 

On both Mac and Windows, uncomment the lines below - `install.packages()` and `devtools::install_github()` - to install the required packages. This only needs to be done once. 

```{r libraries, message=FALSE, warning=FALSE}

knitr::opts_chunk$set(fig.align="center") 

# install.packages(c("rstanarm", "tidyverse", "tidybayes", "modelr", "devtools"))
...
7. a_prior: Select the intercept mean.

8. a_sd: Select the intercept standard deviation.

9. b1_prior: Select the slope mean. 

10. b1_sd: Select the slope standard deviation.
