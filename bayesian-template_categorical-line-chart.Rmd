---
title: "Bayesian template for one ordinal independent variables (line graph)"
...
This template is for data with a **single ordinal independent variable** and will produce a **line chart**. If your analysis includes a **t-test** or **one-way ANOVA**, this might be the right template for you.
