...
This template will produce a **simple bar chart**. If your analysis includes a **t-test** or **one-way ANOVA**, this might be the right template for you.
...
Finally, our modeling system, STAN, will automatically set priors for last parameter, the standard deviation of the normally distributed error term. That is almost never a model parameter that you will be interpreting, and STAN does a reasonable job of assigning weakly informative priors for that parameter in a way that it won't have an impact on the estimation of other parameters, which we normally do care about.

<span style="color:red">**What to change**</span>

4. Control condition mean.

5. Control condition standard deviation 

6. Effect size mean. 

7. Effect size standard deviation.

```{r}

# CHANGE THIS COMMENT EXPLAINING YOUR CHOICE OF PRIORS
...
b1_prior = 0  # CHANGE ME 6
b1_sd = 25    # CHANGE ME 7
